...
from services.services import ProductsServices
from enums.enumsGrafics import EnumsGraph
from products.adbConect import Apiconect
...
class ApiServices():  
    def __init__(self, mt5, selecTime, ASSET, SECONDS, PHONENUMBER, HOURSSTART) :
        ...
        self.services = ProductsServices(self.mt5, self.selecTime, self.ASSET)
